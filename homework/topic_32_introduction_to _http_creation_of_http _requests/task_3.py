appid = "37d7f587c37caeacbb05d33d3e7d36a8"# полученный при регистрации на OpenWeatherMap.org
...
if len(sys.argv) == 2:
    ...
    print('Enter name of city as one argument. For example: Odessa,UA')
    sys.exit()
